...
function computeSharingScore(yearTreeData) {
  var sharedPart =
    yearTreeData.children.ParticipationSalariesAuxResultats.data.value +
    yearTreeData.children.ImpotsSurLesBenefices.data.value;
  var resultatCapitaux =
    yearTreeData.children.ResultatExceptionnel.data.value +
    yearTreeData.children.ResultatAvantImpot.children.ResultatFinancier.data.value;
...
function computeRealEconomyScore(yearTreeData) {
  var charges =
    yearTreeData.children.ResultatAvantImpot.children.ResultatExploitation.children.ChargesExploitation.children;
  return (
    (charges.SalairesEtTraitements.data.value +
      charges.ChargesSociales.data.value +
      charges.ImpotTaxesEtVersementsAssimiles.data.value +
      charges.AchatsDeMarchandises.data.value +
      charges.VariationStockMarchandises.data.value +
      charges.AchatMatierePremiereAutreAppro.data.value +
      charges.VariationStockMatierePremiereEtAppro.data.value -
      yearTreeData.children.ResultatAvantImpot.children.ResultatExploitation.children.ProduitsExploitation.children
        .SubventionsExploitation.data.value) /
    yearTreeData.children.ResultatAvantImpot.children.ResultatExploitation.children.ChargesExploitation.data.value;
  );
}
