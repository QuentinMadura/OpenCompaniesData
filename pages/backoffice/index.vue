<template>
  <div>
    ...
    <!-- BACKOFFICE ROUTES -->
    <BackOfficeScreen :routeConfig="localRouteConfig" :endPointConfig="localEndpointConfig"></BackOfficeScreen>

    <!-- FOOTERS -->
    <Footer v-if="has_footer"></Footer>

    <!-- PROJECT's PARTNERS FOOTER -->
    <DynamicStaticRaw v-if="has_credits_footer" :templateURL="footerConfig.credits_footer_url"></DynamicStaticRaw>
  </div>
</template>
...
export default {
  ...
  middleware: ["getRouteConfig", "checkBackOffice"],
