<template>
  <div id="mainIndexPage">
    ...
    <!-- NAVBAR -->
    <Navbar v-if="has_navbar && !onlyIframe"></Navbar>
    ...
    <!-- TABS -->
    <DynamicTabs v-if="has_tabs" :skipNavbar="has_navbar" :tabsUri="localRouteConfig.tabs_uri"></DynamicTabs>

    <!-- REMOTE STATICS -->
    <div v-if="localRouteConfig.dynamic_template == 'DynamicStatic'">
      <style>
        .img-mini {
          max-width: 120px;
          height: auto;
        ...
        <section id="top" class="hero primary-bg">
          <div class="background columns is-centered top-section">
            <div class="column is-8">
              <br />
              <h1 class="title is-1 has-text-centered">Explorez les données financières des entreprises françaises</h1>
              <form action="/recherche" method="GET" class="columns">
                ...
                <div class="column is-3 is-hidden-mobile">
                  <button
                    ...
                    type="submit"
                  >
                    <span class="is-hidden-touch" style="padding-left: 0.7em"> Rechercher </span>
        ...
        <section class="container">
          <div class="columns is-centered">
            <div class="column is-8 content">
              ...
              <p>
                <a href="/">OpenCompaniesData</a> est un outil de datavisualisation de la base de données
                <a href="https://www.enthic.fr">Enthic</a> qui contient des données sur plus de 1,6 millions
                d'entreprises françaises : bénéfice, chiffre d'affaires, salaire, cotisations sociales, prime
                participation, effectif, impôt, et plus encore (tous les détails d'un compte de résultat en fait).
              </p>
              <p>
                Nous avons monté ce projet libre et ouvert, et nous le réalisons bénévolement sur notre temps libre, car
                nous pensons que ces données doivent être facilement accessible et compréhensible par tous, pour mieux
                comprendre qui crée la richesse en France, qui touche des subventions de la France, qui paye des impôts
                en France, et d'autres question de ce genre que plein de citoyen⋅nes et consommateur/rices français⋅ses
                se posent.
              </p>
            </div>
          </div>
    ...
    <!-- FOOTERS -->
    <Footer v-if="has_footer && !onlyIframe"></Footer>
