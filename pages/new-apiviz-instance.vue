    ...
    <nav class="navbar is-fixed-top" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        ...
        <a class="navbar-item" href="#top">
          <img src="/logos/logo_apiviz_icon_15.png" height="28" />
        </a>
      ...
      <!-- NAVBAR ITEMS -->
      <div id="navbarNewInstance" :class="`navbar-menu ${showNav ? 'is-active' : ''}`">
        <!-- NAV START -->
        <div class="navbar-start">
          <a class="navbar-item" @click="showSteps = false">
            <!-- href="#top" -->
        ...
        <div class="navbar-end">
          <!-- QUICK START -->
          <a class="navbar-item is-uppercase" @click="showSteps = true">
            <!-- href="#currentUUID" -->
            <span>
          ...
          <div class="navbar-item has-dropdown is-hoverable">
            ...
            <div class="navbar-dropdown">
              <a
                v-for="(loc, index) in listLocales"
          ...
          <div :class="`column is-${showSteps ? 10 : 9}`">
            ...
            <div v-show="!showSteps">
              ...
              <div class="has-text-centered">
                ...
                <!-- QUICK START -->
                <a
                  class="button is-primary is-primary-b is-outlined is-large is-rounded is-fullwidth"
                ...
                <div class="columns is-centered is-vcentered is-8">
                  ...
                  <div class="column -is-half">
                    <!-- REPO -->
                    <a
                      class="button is-grey is-grey-b is-outlined is-rounded is-fullwidth"
                      href="https://github.com/co-demos/apiviz-frontend"
                      target="/_blank"
                    >
                      <span class="icon">
            ...
            <div v-show="responseMessage && responseModalOpen">
              <div :class="`notification ${responseStatus === 200 ? 'is-info' : 'is-danger'}`">
                <button class="delete" @click="responseModalOpen = false"></button>
            ...
            <!-- STEPPER -->
            <div v-show="showSteps" ref="thisSteps" class="steps" id="stepGenerator">
              <!-- STEPS ITEMS -->
              ...
              <div class="steps-content">
                  ...
                  <div class="columns is-centered">
                    ...
                    <div class="column is-half">
                        ...
                        <div class="control">
                          <div class="select is-fullwidth is-primary is-primary-b">
                            <select v-model="selectedModel">
                              ...
                              <option v-for="(model, index) in apivizModels.modelUuids" :key="index" :value="model">
                                {{ model.name }}
                              </option>
                            </select>
                          </div>
                      ...
                      <div class="field has-addons">
                        ...
                        <p class="control">
                          <a
                            :class="`${searchLoading ? 'is-loading' : ''} button is-primary is-primary-b is-outlined`"
                            :disabled="!searchUuid"
                            @click="getUUIDmodel()"
                          >
                            <span class="icon">
                    ...
                    <div class="column is-half">
                      <div class="is-divider" :data-content="basicDict.feedback_preview[locale]"></div>
                      <div class="box">
                ...
                <div class="step-content has-text-centered">
                  ...
                  <div v-show="hasNewDataEndpointSetup" class="columns is-centered">
                    <br />
                    <br />
                      ...
                      <div class="control">
                        <div class="field is-horizontal">
                          ...
                          <div class="select is-primary is-primary-b">
                            <select v-model="new_data_selectedDsType" @change="updateJsonData('update_ds_type')">
                              <option :value="null" disabled>
                                {{ basicDict.data_new_endpoint_dsType[locale] }}
                              </option>

                              <option v-for="(dsType, index) in ['dsi', 'dso']" :key="index" :value="dsType">
                                {{ dsType }}
                              </option>
                            </select>
                          </div>
                ...
                <div class="step-content has-text-centered">
                  ...
                  <div v-if="!isCreated" class="columns is-centered">
                    <div class="column is-12">
                      <a
                        ...
                        :class="`button ${createLoading ? 'is-loading' : ''} ${
                          hasAllFields ? 'is-primary is-primary-b' : 'is-grey is-grey-b'
                        } is-rounded is-medium is-fullwidth`"
                  ...
                  <div v-if="isCreated" class="columns is-centered">
                    <div class="column is-half">
                      <a :class="`button is-danger is-rounded is-medium is-fullwidth`" @click="goToNewWebsite()">
                        <span class="icon">
                  ...
                  <div class="columns">
                    ...
                    <div class="column is-one-third">
                      <!-- REPEAT TITLE -->
                      <div class="is-divider" :data-content="basicDict.title_1a[locale]"></div>
                      <p class="content hast-text-centered">
                        <strong>{{ new_title }}</strong>
                      </p>

                      <!-- REPEAT LOGO -->
                      <div class="is-divider" :data-content="basicDict.logo_1c[locale]"></div>
                      <div class="box">
                        <figure class="image">
                          <img :src="new_logoUrl" />
                        </figure>
                      ...
                      <!-- REPEAT ADMIN INFOS -->
                      <div class="is-divider" :data-content="basicDict.admin_1a[locale]"></div>
                      <p class="content hast-text-centered">
                        {{ new_admin_name }}
                      ...
                      <!-- REPEAT DATA INFOS -->
                      <div v-show="hasNewDataEndpointSetup">
                        <div class="is-divider" :data-content="basicDict.data_solidata_endpoint_url_1c[locale]"></div>
                        <p class="content hast-text-centered">
                    ...
                    <div class="column is-one-third">
                      ...
                      <div v-if="selectedModel" class="content has-text-centered">
                        <div v-for="(specs, sfield) in selectedModel.specs" :key="sfield">
                          <div class="is-divider" :data-content="basicDict[sfield][locale]"></div>
                          ...
                          <div v-if="sfield in specsRenderer">
                            <div v-if="specsRenderer[sfield]['render'] === 'colorsLoop'">
                              <table class="table is-bordered is-size-7">
                                ...
                                <tbody>
                                  <tr
                                    v-for="(color, colClass) in specs[specsRenderer[sfield]['field']]"
                                    :key="colClass"
                                  >
                                    <td>
                                      <code>{{ colClass }}</code>
                                    ...
                                    <td class="has-text-centered">
                                      <span class="bd-color" :style="'background : ' + color"> </span>
                                    </td>
                                    <td class="has-text-centered">
                                      <code>
                                        {{ color }}
                            ...
                            <div v-else-if="specsRenderer[sfield]['render'] === 'tagsList'">
                              <div class="tags">
                                <span
                                  v-for="(s, indexS) in specs[specsRenderer[sfield]['field']]"
                            ...
                            <div v-else>
                              <code> ...{{ specs[specsRenderer[sfield]["field"]] }} </code>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default {
  ...
  middleware: ["getDefaultApivizModels"],
  ...
  data() {
    return {
      ...
      new_logoUrl:
        "https://github.com/co-demos/carto-sonum/blob/master/logos/logo%2Bmarianne_typo%20sombre%404x.png?raw=true",
      new_admin_email: "",
      new_admin_name: "",
      new_admin_surname: "",
  ...
  methods: {
    ...
    createApivizInstance() {
      ...
      this.errorMessage = undefined;
      (this.errorModalOpen = false), (this.createLoading = true);

      let request = this.builtRequest;
      // this.log && console.log('\nP-new-apiviz-instance.vue / createApivizInstance / request \n : ', request)
      this.$store
        .dispatch("config/createNewConfig", request)
        .then((resp) => {
