...
export function findBulmaBreakpointByWidth(width) {
  switch (true) {
    case width <= bulmaBreakpoints.xs.maxWidth:
      return bulmaBreakpoints.xs;
    case width <= bulmaBreakpoints.s.maxWidth:
      return bulmaBreakpoints.s;
    case width <= bulmaBreakpoints.m.maxWidth:
      return bulmaBreakpoints.m;
    case width <= bulmaBreakpoints.l.maxWidth:
      return bulmaBreakpoints.l;
    default:
      return bulmaBreakpoints.xl;
  }
}
