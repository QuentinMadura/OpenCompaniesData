export const BackofficeGlobal = Object.freeze({
  ...
  config: [
          ...
          docs: [
            {
              ...
              type: "docs_list",
              canAddToList: true,
              list_filters: [{ field: "dynamic_template", is: ["DynamicStatic"] }],
              help_field: "route_description",
              add_delete: true,
              fields_not_in_model: [
                { subfield: "_id" },
          ...
          docs: [
            {
              ...
              type: "docs_list",
              canAddToList: true,
              list_filters: [{ field: "endpoint_type", is: ["auth_root"] }],
              help_field: "content",
              fields_not_in_model: [
                { subfield: "_id" },
                { subfield: "apiviz_front_uuid" },
    ...
    // USERS
    {
      ...
      icon: "fas fa-users",
      tabs: [
        { tab_code: "us_users", tab_type: "docs", title: "users", docs: [] },
        { tab_code: "us_teams", tab_type: "docs", title: "teams", docs: [] },
      ],
    },
  ],
});
