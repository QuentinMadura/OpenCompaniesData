...
export const getters = {
  ...
  getRefreshToken: (state) => {
    let token =
      typeof state.jwt !== "undefined" && state.jwt.refresh_token === undefined ? "" : state.jwt.refresh_token;
    return token;
  },
};
...
export const actions = {
  ...
  saveLoginInfos({ state, commit, getters, dispatch }, { APIresponse }) {
    ...
    // test user role
    state.log &&
      console.log("S-user-A-saveLoginInfos / then... getCheckUserRole - guest : ", getters.getCheckUserRole("guest"));
    state.log &&
      console.log("S-user-A-saveLoginInfos / then... getCheckUserRole - admin : ", getters.getCheckUserRole("admin"));
  },
