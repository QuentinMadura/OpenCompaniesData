...
const emptyConfig = {
  global: {
    ...
    app_title: {
      ...
      image_preview:
        "https://raw.githubusercontent.com/co-demos/PING-carto/master/documentation/screenshots/map-view-tiers-lieux-01.png",
      is_default: true,
      is_in_navbar: true,
    },
  },
          ...
          images_set: [
            {
              ...
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_1.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_2",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_2.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_3",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_3.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_4",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_4.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_5",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_5.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_6",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_6.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_7",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_7.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_8",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_8.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_9",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_9.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_10",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_10.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_11",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_11.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_12",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_12.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_13",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_13.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_14",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_14.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_15",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_15.png?raw=true",
            },
            {
              credits: "Élise Lalique",
              dft_text: "img_16",
              licence: "",
              src_image:
                "https://raw.githubusercontent.com/co-demos/cis-data/master/illustrations/textures/medium_fiche_16.png?raw=true",
            },
          ],
        },
      ],
        ...
        footer_logos: [
          {
            ...
            position: "block_top_left",
            src_image:
              "https://github.com/co-demos/carto-sonum/blob/master/logos/bloc-web-le-maire-darmanin.png?raw=true",
          },
        ],
        socials_class: {
          default: "",
                ...
                update_src_options: [
                  {
                    ...
                    url_base:
                      "https://geo.api.gouv.fr/departements/<dep_code>/communes?geometry=contour&format=geojson&type=commune-actuelle",
                  },
                ],
              },
            ],
  ...
  endpoints: [
    ...
    },
    {
      ...
      content:
        "apiviz default API endpoint for user authentication (new acces token) : needs a valid refresh token as token ",
      data_type: "user",
...
export const getters = {
  ...
  getRouteConfigTableForDataset: (state, getters, rootState) => {
    let config = state.config.routes.find(function (r) {
      return r.endpoint_type === "table" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getRouteConfigListForDataset: (state, getters, rootState) => {
    let config = state.config.routes.find(function (r) {
      return r.endpoint_type === "list" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getRouteConfigMapForDataset: (state, getters, rootState) => {
    let config = state.config.routes.find(function (r) {
      return r.endpoint_type === "map" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getRouteConfigStatForDataset: (state, getters, rootState) => {
    let config = state.config.routes.find(function (r) {
      return r.endpoint_type === "stat" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getRouteConfigCalendarForDataset: (state, getters, rootState) => {
    let config = state.config.routes.find(function (r) {
      return r.endpoint_type === "calendar" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getEndpointConfig: (state, getters, rootState, rootGetters) => {
    ...
    state.log &&
      console.log(
        "S-config-getEndpointConfig - rootState.search.search.dataset_uri : ",
        rootState.search.search.dataset_uri
      );
    state.log &&
      console.log(
        "S-config-getEndpointConfig - rootState.search.search.endpoint_type : ",
        rootState.search.search.endpoint_type
      );
    ...
    return state.config.endpoints.find(function (r) {
      return (
        r.endpoint_type === rootState.search.search.endpoint_type &&
  ...
  getEndpointConfigByType: (state, getters, rootState) => (endpointType) => {
    ...
    return state.config.endpoints.find(function (r) {
      return r.endpoint_type === endpointType && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  },
  getEndpointConfigFilters: (state, getters, rootState) => {
    // state.log && console.log("S-config-getEndpointConfigFilters - state.config.endpoints : \n", state.config.endpoints)
    let config = state.config.endpoints.find(function (r) {
      return r.endpoint_type === "filters" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getEndpointConfigDetail: (state, getters, rootState) => {
    ...
    let config = state.config.endpoints.find(function (r) {
      return r.endpoint_type === "detail" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
  ...
  getEndpointConfigExport: (state, getters, rootState) => {
    ...
    let config = state.config.endpoints.find(function (r) {
      return r.endpoint_type === "export" && r.dataset_uri === rootState.search.search.dataset_uri;
    });
...
export const actions = {
  ...
  getConfigType({ commit, state, getters, rootGetters }, { type, configTypeEndpoint, args }) {
    ...
    let firstArgs =
      configTypeEndpoint + "?uuid=" + apivizFrontUUID + "&auth_mode=" + authMode + "&token=" + userAccessToken;
    ...
    return axios
      ...
      .catch((err) => state.log && console.log("there was an error trying to fetch some configuration file", err));
  },
