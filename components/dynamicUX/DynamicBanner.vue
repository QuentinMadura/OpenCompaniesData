<template>
  <section
    ...
    :class="`is-hidden-touch ${
      hasFilters ? 'banner-height-with-filters' : 'banner-height-without-filters'
    } has-text-center skip-navbar`"
  >
    <!-- RAW HTML FOR BANNER -->

    <!-- BUTTON TO CLOSE PREVIEW -->
    <div class="buttons is-right">
      <button class="button close is-primary is-primary-b is-inverted" @click="disableBanners">
...
export default {
  ...
  mounted() {
    ...
    let template_url =
      this.currentBanner && this.currentBanner.template_urls
        ? chooseTemplate(this.currentBanner.template_urls, this.locale)
        : "https://raw.githubusercontent.com/co-demos/structure/master/pages-html/error-banner.html";
    ...
    axios
      ...
      .catch((err) => {
        this.rawHtml = "<br><br>there is an <strong> Error </strong><br><br>";
      });
  },
