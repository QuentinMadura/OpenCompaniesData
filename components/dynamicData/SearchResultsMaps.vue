<template>
  <div class="map">
    <div class="count-and-tabs-container">
      <div class="container">
        <SearchResultsCountAndTabs :view="VIEW_MAP" :open="!!showCard">
          <!-- HIGHLIGHTED ITEM  -->
          <div class="highlighted-project" v-if="showCard" slot="project">
            <!-- BUTTON TO CLOSE PREVIEW -->
            <button v-show="itemLoaded" class="button close" @click="showCard = false">
            ...
            <div class="card">
              <!-- LOADER -->
              <div class="columns is-mobile is-vcentered" v-show="!itemLoaded">
              ...
              <!-- ITEM DATA -->
              <ProjectCard v-if="itemLoaded" :item="highlightedItem" :contentFields="contentFields" :view="VIEW_MAP">
              </ProjectCard>
            </div>
          </div>
    ...
    <!-- LOADER -->
    <div v-show="!projects || itemLoading" class="lds-roller floating">
      <div></div>
      <div></div>
      <div></div>
      <div></div>
