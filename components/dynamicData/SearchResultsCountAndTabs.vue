<template>
  ...
  <div :class="`count-and-tabs`">
    ...
    <div :class="['result-count-parent', open ? 'open' : undefined]">
      <div v-if="view != VIEW_STAT" :class="`results-count`">
        <span class="nb has-text-primary has-text-primary-c">
          {{ pending ? "?" : total }}
        </span>
        <!-- v-if="breakpoint.btnsAsAddons" -->
        <span :class="`${breakpoint.btnsAsAddons ? '' : 'is-size-7'}`">
    ...
    <!-- BTNS VIEWS -->
    <div :class="`buttons ${breakpoint.btnsAsAddons ? 'has-addons' : ''} is-right`">
      <!-- BTN TABLE -->
      <nuxt-link
        ...
        :class="[
          ...
          view === VIEW_TABLE ? 'is-selected is-primary is-primary-b' : 'has-text-primary-hover-c',
          smallButtons ? '' : '',
        ]"
      >
      ...
      <nuxt-link
        ...
        :class="[
          'has-text-centered button ',
          view === VIEW_LIST ? 'is-selected is-primary is-primary-b' : 'has-text-primary-hover-c',
          smallButtons ? '' : '',
        ]"
      >
        <span class="icon has-text-centered is-marginless">
      ...
      <nuxt-link
        ...
        :class="[
          'has-text-centered button ',
          view === VIEW_MAP ? 'is-selected is-primary is-primary-b' : 'has-text-primary-hover-c',
          smallButtons ? '' : '',
        ]"
      >
        <span class="icon has-text-centered is-marginless">
      ...
      <nuxt-link
        ...
        :class="[
          'has-text-centered button ',
          view === VIEW_STAT ? 'is-selected is-primary is-primary-b' : 'has-text-primary-hover-c',
          smallButtons ? '' : '',
        ]"
      >
        <span class="icon has-text-centered is-marginless">
      ...
      <nuxt-link
        ...
        :class="[
          'has-text-centered button ',
          view === VIEW_CALENDAR ? 'is-selected is-primary is-primary-b' : 'has-text-primary-hover-c',
          smallButtons ? '' : '',
        ]"
      >
        <span class="icon has-text-centered is-marginless">
    ...
    <div :class="'buttons is-right'">
      ...
      <a
        ...
        @click="reShuffle()"
      >
        <span :class="`icon ${shuffleSeed ? 'has-text-primary-c' : ''}`">
          <i class="fas fa-random"></i>
        </span>
      </a>
...
export default {
  ...
  mounted() {
    ...
    this.log &&
      console.log("C-SearchResultsCountAndTabs / this.endpointConfigUrlToTable : ", this.endpointConfigUrlToTable);
    this.log &&
      console.log("C-SearchResultsCountAndTabs / this.endpointConfigUrlToList  : ", this.endpointConfigUrlToList);
    this.log &&
      console.log("C-SearchResultsCountAndTabs / this.endpointConfigUrlToMap   : ", this.endpointConfigUrlToMap);
    this.log &&
      console.log("C-SearchResultsCountAndTabs / this.endpointConfigUrlToStat  : ", this.endpointConfigUrlToStat);
  },
  ...
  methods: {
    ...
    exportDataset() {
      ...
      this.$store.dispatch("search/exportDataset").then((response) => {
