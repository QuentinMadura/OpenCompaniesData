<template>
  <DynamicSearchScreenSqueleton :filtersConfig="filtersConfig" mainClass="calendar">
    <!-- TEMPORARILY COMMENTED -->
    <SearchResultsCalendar :routeConfig="routeConfig" />
...
import SearchResultsCalendar from "./SearchResultsCalendar.vue";
