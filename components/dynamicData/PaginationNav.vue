<template>
  <!-- TABLE NAVIGATION -->
  <div v-show="show" class="pagination-block is-centered">
    <div class="pagination">
      <div class="field has-addons">
        <!-- PREVIOUS PAGE -->
        <div class="control">
          <button
            class="button has-text-primary-hover-c"
        ...
        <div class="control">
          <div class="select">
            <select @change="changePerPageSelection($event)" v-model="perPage">
              <option v-for="(pp, index) in perPageOptions" :key="index" :selected="pp === perPage" :value="pp">
    ...
    <div v-if="feedback && (feedback === position || feedback === 'top_and_bottom')" class="pagination">
