<template>
  <div :class="`column is-12 ${view === 'VIEW_MAP' ? 'hover-effect' : ''}`">
    <div :class="`card proj-card ${view === 'VIEW_LIST' ? 'hover-effect' : ''}`">
      <!-- DEBUGGING -->
      <!-- <div class="container"> -->
      <!-- -- ProjectCard --<br> -->
      ...
      <!-- BLOCK IMAGE -->
      <nuxt-link :to="`/${dataset_uri}/detail?id=${matchItemWithConfig('block_id')}`" class="card-image">
        <img class="proj-card-img" :src="itemImage('block_image')" :alt="itemInfos.title" />
