<template>
  ...
  <section class="main-content skip-navbar columns is-fullheight">
    <!-- SIDE MENU -->
    <aside class="column noPaddingBottom is-full-mobile is-4-tablet is-3-desktop is-3-widescreen is-3-fullhd section">
      <p class="menu-label">
      ...
      <!-- MENUS -->
      <ul class="menu-list">
        <li v-for="uMenu in userMenu" :key="uMenu.title">
          <nuxt-link :to="uMenu.url" :class="`${uMenu.title == activeMenu ? 'is-active' : ''}`">
    ...
    <div class="container column noMarginLeft is-full-mobile is-7-tablet is-7-desktop is-7-widescreen is-6-fullhd">
      <div class="section">
        <br /><br />
