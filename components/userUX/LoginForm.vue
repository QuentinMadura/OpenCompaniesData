<template>
  <div>
    <h5 class="title has-text-grey" v-if="!user.isLoggedin">
      <!-- {{ getText('login') }} -->
      {{ basicDict.login[locale] }}
    </h5>

    <form v-if="!user.isLoggedin" v-on:submit.prevent="sendLoginForm" name="form">
      ...
      <div class="field">
        <!-- <div class="control has-icons-left"> -->
        <input class="checkbox" name="userRememberMe" type="checkbox" value="" />
        <label for="checkbox">
          <!-- remember me -->
          <!-- {{ getText('remember_me') }} -->
      ...
      <button class="button is-block is-primary is-primary-b is-fullwidth" type="submit">
        <!-- @click="sendLoginForm" -->
        <span class="icon">
    ...
    <div v-if="isUserAdmin || isUserStaff">
      <button v-if="user.isLoggedin" class="button is-block is-primary is-primary-b is-fullwidth" @click="goBack">
        <span class="icon">
      ...
      <nuxt-link class="button is-block is-fullwidth is-primary is-primary-b" :to="'/backoffice'">
        <span class="icon">
