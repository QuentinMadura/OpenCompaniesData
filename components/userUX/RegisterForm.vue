<template>
  <div>
    ...
    <form v-on:submit.prevent="sendRegisterForm" name="form" v-if="!user.isLoggedin">
      ...
      <!-- SUBMIT -->
      <button class="button is-block is-primary is-primary-b is-fullwidth" :disabled="!enableBtn" type="submit">
        <!-- REGISTER -->
        <span class="icon">
    ...
    <p class="button is-block is-primary is-primary-b is-fullwidth" type="submit" v-if="user.isLoggedin">
      <!-- USER CONNECTED -->
